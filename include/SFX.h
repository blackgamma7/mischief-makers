...
#define SFX_CLANCER_LAUGH0      0X009C //UNKNOWN IF USED
#define SFX_CLANCER_YELP        0X009D
#define SFX_CLANCER_CHATTER0    0X00A0 //UNKNOWN IF USED
#define SFX_CLANCER_CRYING      0X00A1
#define SFX_CLANCER_CHATTER     0X00A2
